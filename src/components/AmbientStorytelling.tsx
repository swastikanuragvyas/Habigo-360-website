...
export function DarkModeToggle() {
  ...
  return (
    <button
      onClick={handleClick}
      className={`fixed top-20 right-6 z-40 size-11 rounded-full flex items-center justify-center transition-all duration-300 ${
        dark
          ? "bg-ivory text-emerald-deep hover:bg-accent"
          : "bg-emerald-deep/85 backdrop-blur-md border border-ivory/15 text-accent hover:bg-accent hover:text-emerald-deep"
      }`}
    ...
    >
      <div
        ...
        style={{
          transform: dark ? "rotate(0deg) scale(1)" : "rotate(180deg) scale(1)",
        }}
      >
