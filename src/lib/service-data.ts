...
export const SERVICE_PAGES: Record<string, ServicePage> = {
  "social-media-marketing": {
    ...
    description:
      "We build always-on content ecosystems that turn passive scrollers into loyal communities. From editorial calendars to viral-ready reels, we engineer digital communities that compound - not just post.",
    deliverables: [
  ...
  "seo-services": {
    slug: "seo-services",
    title: "SEO Services",
    tagline: "Own the search results. Own the category.",
    description:
      "We engineer websites to dominate search engines through technical precision, authoritative content, and strategic link building. Ranking #1 isn't luck—it's architecture.",
    deliverables: [
      "Comprehensive technical SEO audits",
      "Keyword research & content strategy mapping",
      "On-page optimization & schema markup",
      "High-authority backlink acquisition",
      "Local SEO & Google Business Profile management",
      "Monthly ranking & organic traffic reporting",
    ],
    approach:
      "Our SEO process begins with a rigorous technical foundation. We ensure your site structure, load speeds, and crawlability meet the exact standards search engines demand before we even look at keywords.\n\nContent is driven by search intent, not just search volume. We identify the exact questions your customers are asking and build authoritative pages that answer them better than anyone else in your industry.\n\nOff-page, we build relationships that earn high-quality, relevant backlinks—signaling trust and authority to algorithms.\n\nWe don't chase vanity metrics. Every SEO decision is tied to organic revenue growth, and our transparent reporting shows exactly how your search visibility translates into bottom-line impact.",
    stats: [
      { label: "Organic Traffic Lift", value: "120%" },
      { label: "Keywords Ranked", value: "500+" },
      { label: "Avg. Rank Increase", value: "12+" },
      { label: "ROI on SEO", value: "4.5x" },
    ],
  },
  ...
  "photography-videography": {
    ...
    description:
      "Cinematic capture for hospitality, lifestyle, fitness & sports and brand storytelling. From drone aerials to intimate product close-ups, we produce visual assets that elevate every touchpoint - not just the Instagram grid.",
    deliverables: [
    ...
    stats: [
      { label: "Shoots Completed", value: "150+" },
      { label: "Assets Delivered", value: "5K+" },
      { label: "Drone Shoots", value: "40+" },
      { label: "Brands Captured", value: "20+" },
    ],
  },
  ...
  "branding-identity": {
    ...
    stats: [
      { label: "Brand Systems Built", value: "5+" },
      { label: "Industries Covered", value: "2+" },
  ...
  "influencer-marketing": {
    ...
    stats: [
      { label: "Influencers Activated", value: "30+" },
      { label: "Campaign Reach", value: "5mil+" },
      { label: "Avg. Engagement", value: "5%" },
      { label: "Campaigns Launched", value: "3+" },
    ],
  },
  ...
  "email-whatsapp-marketing": {
    ...
    tagline: "Direct communication that turns subscribers into loyal buyers.",
    description:
      "Lifecycle journeys and conversational commerce combined. From email sequences to WhatsApp chatbots, we design and automate direct communication channels that generate revenue on autopilot.",
    deliverables: [
      "Email strategy & lifecycle journey mapping",
      "WhatsApp Business API setup & configuration",
      "List segmentation & audience targeting",
      "Template design & responsive development",
