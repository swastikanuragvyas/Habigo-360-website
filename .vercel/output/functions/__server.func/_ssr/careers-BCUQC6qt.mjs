...
import { l as logoImg } from "./router-DsNkOnnW.mjs";
import "../_libs/seroval.mjs";
import { A as ArrowUpRight, X, e as Menu, k as ArrowLeft, B as BriefcaseBusiness, h as MapPin, S as Sparkles, l as Target, U as Users, m as Clock3, a as Mail, i as Send } from "../_libs/lucide-react.mjs";
...
function CareersPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 lg:py-32 bg-ivory-warm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1500px] mx-auto px-6 lg:px-10 grid lg:grid-cols-12 gap-12 items-start", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-7 space-y-4", children: openings.map((role) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setSelectedRole(role), className: "group w-full text-left bg-background border border-emerald-deep/10 rounded-sm p-6 lg:p-8 hover:bg-emerald-deep hover:text-ivory transition-colors duration-300", children: [
