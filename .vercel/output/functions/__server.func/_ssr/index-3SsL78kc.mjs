...
import { l as logoImg, c as NAV, d as SERVICES, s as submitContact, f as founder1, e as founder2, u as useReveal$1, a as api } from "./router-Db_gZD6m.mjs";
import { a as useMutation, u as useQuery } from "../_libs/tanstack__react-query.mjs";
import "../_libs/seroval.mjs";
import { b as MessageCircle, a as Mail, g as Phone, h as MapPin, i as Send, I as Instagram, L as Linkedin, f as Twitter, A as ArrowUpRight, X, e as Menu, V as Funnel, l as ChevronLeft, m as ChevronRight, W as Minus, y as Plus, R as CircleCheck, Y as SquarePlus, Z as Grid3x3, _ as SquarePlay, $ as SquareUser, a0 as House, a1 as Search, a2 as User } from "../_libs/lucide-react.mjs";
...
function ImmersiveHero() {
  ...
  const yText = useTransform(scrollY, [0, 1e3], ["0%", "100%"]);
...
function LivingPortfolio() {
  ...
  const dynamicCaseStudies = (dbCaseStudies || []).filter((cs) => cs.visibility !== false).map((cs) => ({
  ...
  const [maxScroll, setMaxScroll] = reactExports.useState(0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "work", className: "bg-emerald-deep text-ivory py-28 lg:py-40", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1500px] mx-auto px-6 lg:px-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ref,
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-6 font-display text-[clamp(2rem,4.5vw,4.5rem)] leading-[1.02] font-light", children: [
                "Case studies, ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "italic text-accent", children: "not portfolios." })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                children: "Request full case studies →"
              }
            )
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3 mb-10", children: FILTERS.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          onClick: () => setFilter(f.id),
          className: `text-[10px] uppercase tracking-[0.22em] px-5 py-2.5 rounded-full border transition-all duration-300 ${filter === f.id ? "bg-accent text-emerald-deep border-accent font-semibold" : "border-ivory/20 text-ivory/60 hover:border-ivory/50 hover:text-ivory"}`,
          children: [
            f.id === "all" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Funnel, { className: "!size-3 inline mr-1.5" }) : null,
            f.label
          ]
        },
        f.id
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: filtered.map((project, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "article",
              {
                className: "snap-start shrink-0 w-[85vw] md:w-[45vw] lg:w-[38vw] xl:w-[32vw] group cursor-pointer",
                onClick: () => setLightbox(idx),
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[4/3] overflow-hidden rounded-sm bg-emerald-soft", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                      {
                        src: project.img,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-emerald-deep via-emerald-deep/20 to-transparent opacity-80" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 right-4 bg-ivory/95 backdrop-blur text-emerald-deep text-[9px] font-semibold uppercase tracking-wider px-3 py-1.5 rounded-full", children: project.tag }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-0 bottom-0 p-6 lg:p-8", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl lg:text-3xl text-ivory", children: project.title }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-accent/80 mt-2 font-semibold", children: project.meta })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-emerald-deep/0 group-hover:bg-emerald-deep/40 transition-colors duration-500 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-14 rounded-full bg-accent/90 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-4 group-hover:translate-y-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "!size-6 text-emerald-deep" }) }) })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-ivory/60 leading-relaxed line-clamp-2", children: project.description })
                ]
              },
              `${filter}-${idx}`
            ))
        ...
        filtered.length > 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => scroll(-1),
        ...
        filtered.length > 2 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-0.5 bg-ivory/10 rounded-full mt-4 max-w-md mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
    ...
    lightbox !== null && currentProject && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-3 aspect-[4/3] md:aspect-auto relative", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-emerald-deep/60 via-transparent to-transparent" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 p-8 lg:p-10 flex flex-col justify-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-[0.25em] text-accent font-semibold mb-3", children: currentProject.tag }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-3xl lg:text-4xl", children: currentProject.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-foreground/70 leading-relaxed", children: currentProject.description }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 space-y-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-[0.22em] text-foreground/50", children: "Key Results" }),
                    currentProject.results.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-sm", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "size-1.5 rounded-full bg-accent shrink-0" }),
                      r
                    ] }, i))
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-4 left-4 right-4 flex justify-between pointer-events-none", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    onClick: () => setLightbox(
                      (prev) => prev !== null ? prev > 0 ? prev - 1 : filtered.length - 1 : 0
                    ),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    onClick: () => setLightbox(
                      (prev) => prev !== null ? prev < filtered.length - 1 ? prev + 1 : 0 : 0
                    ),
                    className: "pointer-events-auto size-10 rounded-full bg-ivory/90 text-emerald-deep flex items-center justify-center hover:bg-accent transition-colors",
                    "aria-label": "Next",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "!size-5" })
...
function HabiGoHome() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(LivingPortfolio, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(InstagramMockups, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "defer-render", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Testimonials, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "defer-render", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FAQs, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "defer-render", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Contact, {}) }),
...
function Nav({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: `fixed inset-x-0 z-50 transition-all duration-500 flex justify-center px-4 md:px-6 ${scrolled ? "top-4" : "top-0"}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `max-w-[1500px] w-full mx-auto px-6 lg:px-10 flex items-center justify-between transition-all duration-500 ${scrolled ? "h-16 rounded-full bg-[color:var(--emerald-deep)]/70 backdrop-blur-2xl border border-white/10 shadow-2xl" : "h-20 bg-transparent rounded-none border-transparent"}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden lg:flex items-center gap-2", children: NAV.map((n) => {
        if (n.id === "services") {
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", onMouseEnter: openDropdown, onMouseLeave: closeDropdown, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "/services", className: `text-[11px] uppercase font-medium tracking-[0.15em] transition-all px-4 py-2.5 rounded-full inline-block ${dropdownOpen ? "text-accent bg-white/10" : "text-ivory hover:text-accent hover:bg-white/5"}`, children: [
              n.label,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute top-[calc(100%+0.5rem)] left-1/2 -translate-x-1/2 w-72 bg-emerald-deep/80 backdrop-blur-3xl border border-white/10 shadow-2xl rounded-2xl overflow-hidden transition-all duration-300 ${dropdownOpen ? "opacity-100 translate-y-0 pointer-events-auto" : "opacity-0 translate-y-3 pointer-events-none"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-3", children: [
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: n.href ?? (n.id === "home" ? "/" : n.id === "about" ? "/about" : `/#${n.id}`), className: "text-[11px] uppercase font-medium tracking-[0.15em] text-ivory hover:text-accent hover:bg-white/5 transition-all px-4 py-2.5 rounded-full", children: n.label }, n.id);
      }) }),
...
function Founders() {
  ...
  const getImg = (key, def) => settings?.find((s) => s.key === key)?.value || def;
  const f = [{
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "services", className: "bg-background py-28 lg:py-40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1500px] mx-auto px-6 lg:px-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-12 gap-10 mb-16 items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-6 font-display text-[clamp(2rem,4.5vw,4.5rem)] leading-[1.02] font-light text-balance", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TextReveal, { text: "Twelve disciplines." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "italic text-emerald-deep", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TextReveal, { text: "One growth engine.", delay: 300 }) })
        ] })
      ] }),
...
function Testimonials() {
  ...
  const dynamicTestimonials = (dbTestimonials || []).filter((t2) => t2.visibility !== false).map((t2) => ({
    q: t2.review,
    n: t2.clientName,
    r: t2.role ? `${t2.role}, ${t2.company}` : t2.company
  }));
