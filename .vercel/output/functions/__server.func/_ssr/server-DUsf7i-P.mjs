...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Bx6uIZ7_.mjs");
...
const manifest = {
  "903e5423f95a9ce2ad984c09fb5bd530215cdf4c61e84904753bd0412f9d50a3": {
    functionName: "submitContact_createServerFn_handler",
    importer: () => import("./contact.server-DKiWbecX.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DsNkOnnW.mjs").then((n) => n.r),
    import("./start-BsmqYikl.mjs"),
